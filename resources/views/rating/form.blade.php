        ...
        <div class="card-body p-4">
            ...
            <div class="rating-section">
                ...
                <form action="{{ route('rating.store') }}" method="POST">
                    ...
                    <input type="hidden" name="buku_id" value="{{ $peminjaman->id_buku }}">
                    ...
                    <div class="rating-input-wrapper bg-light rounded-3 p-4 mb-4 shadow-sm">
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <div id="rating-error" class="text-danger mt-2 d-none">
                                <small><i class="bx bx-error-circle me-1"></i>Silakan pilih rating terlebih dahulu</small>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    stars.forEach(star => {
        star.addEventListener('click', function() {
            ...
            // Hide error saat rating dipilih
            document.getElementById('rating-error').classList.add('d-none');
            document.querySelector('.rating-input-wrapper').style.border = '';
        });
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        if (!ratingChecked) {
            ...
            document.querySelector('.rating-input-wrapper').style.border = '2px solid #dc3545';
